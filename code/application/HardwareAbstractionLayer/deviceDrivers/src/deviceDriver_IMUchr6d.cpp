/**
 *\file deviceDriver_IMUchr6d.cpp
 *\brief The Device driver uses a SerialPort to request and wait for data packets.
 * It parses the packets and provides access to the latest received data.
 *\author Jan
*/
